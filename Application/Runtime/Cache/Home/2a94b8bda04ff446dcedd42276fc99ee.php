    ...
    <div class="l-article_r">
        ...
        <div class="box-sort" monkey="cool">
            ...
            <ul class="m span-rows box-sort_content">
                ...
                <!--轮播展示-->
                <script type="text/javascript" src="/mr_navigation/Public/js/jquery.flexslider-min.js"></script>
            ...
            <div class="box-tools">
                <ul class="m span-rows box-tools_content">
                    <?php if(is_array($bottom_array)): foreach($bottom_array as $key=>$vo): ?><li>
                            <span class="box-tools_title"><a href="life.htm"><?php echo ($key); ?></a></span>
                            <span class="box-tools_more"><a href="life.htm">更多&gt;&gt;</a></span>
                        ...
                        <!--以下数据是为演示界面效果而生成，实际应用中可去掉-->
                        <li>
                            <span class="box-tools_title"><a href="soft.htm">软件专区</a></span>
                            <span class="box-tools_more"><a href="soft.htm">更多&gt;&gt;</a></span>
